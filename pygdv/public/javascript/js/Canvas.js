/*
 * This script will handle the loading of databases scores
 * for each quantitative track in the browser interface.
 * It will request the score from GDV via a POST request,
...
/**
 * simulate a buffer that receives all post to send
...
/**
 *  Get a Track by its id. Return an empty array if the key does not exist.
...
/**
 * Regroups all methods to fetch score & draw them on a canvas
 */
...
/**
 * function which creates and adds a div next to GenomeBrowser
 */
...
/**
 * draw the scale next to each quantitative track
 */
