...
FeatureTrack.prototype.loadSuccess = function(trackInfo) {
    ...
    if (trackInfo.clientConfig) {
        ...
        if (cc.featureCallback) {
            try {
                ...
                console.log("eval failed for featureCallback: " + cc.featureCallback);
            }
        }
    }
    ...
    if (! trackInfo.urlTemplate) {
        ...
        showPanelInfo(this, _gdv_info.sequence_id,
		      feat[fields["name"]],feat[fields["start"]],feat[fields["end"]]);
