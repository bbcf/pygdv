...
Track.prototype.setScale = function(scale){
    //TODO
}

Track.prototype.getScale = function(){
    //TODO
}

Track.prototype.setViewInfo = function(heightUpdate, numBlocks, trackDiv, labelDiv, widthPct, widthPx, scale) {
    var track = this;
...
Track.prototype.showRange = function(first, last, startBase, bpPerBlock, scale, containerStart, containerEnd) {
...
Track.prototype._showBlock = function(blockIndex, startBase, endBase, scale, containerStart, containerEnd) {
    if (this.blocks[blockIndex]) {
    ...
    for (i = 0; i < this.blocks.length; i++) {
        ...
        if ((newIndex < 0) || (newIndex >= this.numBlocks)) {
            ...
            if (newBlocks[newIndex])
                newBlocks[newIndex].style.left = ((newIndex) * this.widthPct) + "%";
...
Track.prototype.sizeInit = function(numBlocks, widthPct, blockDelta) {
    ...
    if (this.blocks && (this.blocks.length > 0)) {
        ...
        if (this.blocks.length != numBlocks)
            throw new Error("block number mismatch: should be " + numBlocks + "; blocks.length: " + this.blocks.length);
